    ...
    return (
        <div className="bg-primary">
            ...
            <div className=" flex py-10 gap-20 md:flex-col">
                <div className="flex flex-col gap-10 border-l-2 border-[#fba66a] w-1/3 md:flex-row md:overflow-x-scroll md:w-full">
                    {experiences.map((experience, index) => (
                        ...
                        >
                            ...
                            ${selectedItemIndex === index
                                    ? 'text-tertiary border-tertiary border-l-4 -ml-[3px] md:ml-0 bg-[#f9741634] py-3 md:w-full'
                                    : 'text-white py-3'
                                }`}
                            >
                                {experience.period}
